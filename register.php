...
if(isset($_POST['btn']))
{
	...
	$sql="insert into customer(name,email,contact,bike_model,time,city,city1)values('$name','$email',$contact,'$bike_model','$time','$city','$city1')";
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="register.php" class="nav-item nav-link active">Book Now</a>

...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">Royal Bikes</span></h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="img/bike3.jpg" alt="image">
                    <p>Customers love to book online because they can book at all hours of the day. Give them the experience they want by adding online booking to your website, while reducing the time you spend answering call and emails.</p>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">24/7  Bike Support</h4>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">

...
if(isset($_POST['btn']))
{
	...
	{
	$sql="insert into customer(name,email,contact,address,bike_model,time,payment,city,image)values('$name','$email',$contact,'$address','$bike_model','$time',$payment,'$city','$imagename')";
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="bikedetail.php" class="dropdown-item">our bikes</a>
                                
                                <a href="booking.html" class="dropdown-item">Bike Booking</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                ...
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form name="f1" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <textarea class="form-control py-3 px-4" rows="5" placeholder="address" required="required" name="addresss"></textarea>
                            </div>
							<div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="Bike_model" required="required" name="bike_model">
                            </div>
							<div class="form-group">
                                <input type="time" class="form-control p-4" placeholder="Hour" required="required" name="time">
                            </div>
							<div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="payment" required="required" name="payment">
                            </div>
							<div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="City" required="required" name="city">
                            </div>
							<div class="form-group">

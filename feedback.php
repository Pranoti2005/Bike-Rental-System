...
if(isset($_POST['btn']))
{
	$c_name=$_POST['c_name'];
	$email=$_POST['email'];
	$c_feedback=$_POST['c_feedback'];
	$sql="insert into feedback(c_name,email,c_feedback)values('$c_name','$email','$c_feedback')";
                        ...
                        <form name="f1" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" class="form-control p-4" placeholder="Your Name" required="required" name="c_name">
                                </div>
                                <div class="col-6 form-group">
                           ...
                           <div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="feedback" required="required" name="c_feedback">
                            </div>
                            <div>

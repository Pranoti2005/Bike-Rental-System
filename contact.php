...
if(isset($_POST['btn']))
{
	...
	$sql="insert into customer(name,email,contact,bike_model,time,city)values('$name','$email',$contact,'$bike_model','$time','$city')";
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="register.php" class="nav-item nav-link active">Register Now</a>
                    </div>
                </div>
            </nav>
        </div>
   ...
   <!-- <div class="container-fluid page-header">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Register Now</h1>
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form name="f1" method="post" enctype="multipart/form-data">
							...
							<input type="radio" name="payment" value="male">Card 
							<input type="radio" name="payment" value="female">Cash<br>
							</div>-->
                            <div>
